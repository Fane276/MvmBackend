...
{
    public abstract class MvManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MvManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MvManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MvManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MvManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MvManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MvManagementDbContext, Task<T>> func)
        {
            T result;
