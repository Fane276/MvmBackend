...
{
    public abstract class MvMangementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MvMangementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MvMangementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MvMangementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MvMangementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MvMangementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MvMangementDbContext, Task<T>> func)
        {
            T result;
